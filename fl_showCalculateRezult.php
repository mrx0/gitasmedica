...
//!!! не используется, не доделано
//fl_showCalculateRezult.php
//функция формирует и показывает массив расчетов

    function showCalculateRezult($ZapisHereQueryToday, $edit_options, $upr_edit, $admin_edit, $stom_edit, $cosm_edit, $finance_edit, $type, $format, $menu){
