    ...
    if (empty($_SESSION['login']) || empty($_SESSION['id'])){
        ...
        if ($_POST){
            ...
            if (!isset($_POST['cat_name']) || !isset($_POST['work_percent']) || !isset($_POST['material_percent']) || !isset($_POST['personal_id'])){
                ...
                $query = "SELECT * FROM `fl_percents` WHERE `type`='{$_POST['personal_id']}'";
                ...
                if ($number != 0) {
                    ...
                    echo json_encode(array('result' => 'success', 'data' => '<div class="query_ok"><a href="certificate.php?id=' . $cert_id . '" class="ahref">Категория процентов</a> добавлена.</div>'));
                }
            }
        }
    }
