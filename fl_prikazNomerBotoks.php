...
//                $msql_cnnct = ConnectToDB();
                ...
                //Получим месяц и год табеля, из которого инициировала приказ номер 8 (!!!2021-01-12 данные этого запроса нигде далее не используются)
...
//                    }
                    ...
                    //Сейчас тут Ботокс
                    $controlCategories = array(23);
                    //Категории, которые надо вычесть перед контролем
//                    $controlCategoriesMinus = array();
//
