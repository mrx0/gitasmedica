...
//worker_zapis_report2.php
//Отчет по посещениям к врачам
...
//            }
            ...
            $datas = fl_main_report2_f($month, $year, $filial_id, $worker_id);
...
//            var_dump($zapis_j);
            ...
            $dop = 'filial_id='.$filial_id.'&worker_id='.$worker_id;
...
<!--                        <div class="nav never_print_it">
                        ...
                        <h2 style="padding: 0;">Отчёт посещений по врачу</h2>
                    </header>';
...
//            var_dump(time());
            ...
            if (TRUE) {
                ...
                echo widget_calendar ($month, $year, 'worker_zapis_report2.php', $dop);
                echo '</div>';
                ...
                echo '
                            <div class="no_print" style="/*font-size: 90%; */">
                                <li class="filterBlock">
                                    ...
                                    <div class="filtercellRight" style="width: 300px; min-width: 300px;">';
                if (($finances['see_all'] == 1) || ($finances['see_own'] == 1) || $god_mode){
                    echo '
                                        <input type="text" size="30" name="searchdata4" id="search_client4" placeholder="Минимум три буквы для поиска" value="'.WriteSearchUser('spr_workers', $worker_id, 'user_full', false).'" class="who4" autocomplete="off">
                                        <span class="button_tiny" style="font-size: 100%; cursor: pointer" onclick="changeWorkerWZR();"><i class="fa fa-check-square" style=" color: green;"></i> Изменить</span>
                                        <ul id="search_result4" class="search_result4"></ul><br>';
                }else{
                    echo
                                        WriteSearchUser('spr_workers', $worker_id, 'user_full', false).'
                                        <input type="hidden" id="search_client4" name="searchdata4" value="'.WriteSearchUser('spr_workers', $worker_id, 'user_full', false).'">';
                }
                echo '
                                    </div>
                                </li>
...
/*                        
                    ...
                    function changeWorkerWZR(){        
                        var link = "search_user_f.php";
                            
                        var reqData = {
                            workerFIO: $("#search_client4").val()
                        };
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                ...
                                document.location.href = "?worker_id="+ res.data.id + "&" + get_data_str;
                            }
                        });
                    }			
