...
//cert_name_add_f.php
//Функция добавления сертификата именного непосредственно в БД
    ...
    if (empty($_SESSION['login']) || empty($_SESSION['id'])){
        ...
        if ($_POST){
            ...
            if (!isset($_POST['num']) || !isset($_POST['nominal'])){
                ...
                $query = "SELECT * FROM `journal_cert_name` WHERE `num`='{$_POST['num']}'";
                ...
                if ($number != 0) {
                    ...
                    if (mb_strlen($_POST['num']) <= 2) {
                        ...
                        $cert_id = WriteCertToDB_Edit($_SESSION['id'], $_POST['num'], $_POST['nominal'], 'journal_cert_name');

                        echo json_encode(array('result' => 'success', 'data' => '<div class="query_ok"><a href="certificate_name.php?id=' . $cert_id . '" class="ahref">Сертификат</a> добавлен.</div>'));
                    }
                }
            }
        }
