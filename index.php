		...
		echo '
			...
			echo '
				...
				<div id="data">';
					...
					echo '
						- 
						- В журнале стоматологов иконкой будут отмечаться страховые посещения<bВ посещениях стоматологов добавлена галочка "страховой" для страховых посещений<br />r />
						<br />';
