...
//stat_lost_pervich.php
//Пропавшая первичка v2.0. Поиск тех, у кого была консультация и они больше не пришли
...
//														}
				...
				echo '
                        <div class="no_print"> 
						<input type="button" class="b" value="Применить" onclick="Ajax_show_result_stat_lost_pervich()">
						</div>';
                ...
                echo '
						<div id="status">
							...
							<ul style="border: 1px dotted #CCC; margin: 10px; width: auto;" id="q2result">
