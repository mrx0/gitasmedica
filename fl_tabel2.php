...
//fl_tabel2.php
//Табель для админов (и ассистов) (!!! 2020-10-14 не используется)
                        ...
                        foreach ($tabel_ex_calculates_j as $rezData){
                            ...
                            foreach ($percent_cats_arr as $percent_cat){
                                ...
                                if ($percent_cat > 0) {
                                    ...
                                    $rezult .= '<i style="color: red; font-size: 100%;">Ошибка #67</i><br>';
                                }
...
//                        }
                        ...
                        if (($tabel_j[0]['status'] != 7) && ($tabel_j[0]['status'] != 9) && (($finances['see_all'] == 1) || $god_mode)) {
                            ...
                            echo '<div style="display: inline;"><a href="fl_surcharge_in_tabel_add.php?tabel_id='.$_GET['id'].'&type=1&w_type='.$tabel_j[0]['type'].'" class="b" style="font-size: 80%;">Прочее +</a></div>';
                        }
                        ...
                        if (($tabel_j[0]['status'] != 7) && ($tabel_j[0]['status'] != 9) && (($finances['see_all'] == 1) || $god_mode)) {
                            ...
                            echo '<div style="display: inline;"><a href="fl_paidout_in_tabel_add.php?tabel_id='.$_GET['id'].'&type=2&w_type='.$tabel_j[0]['type'].'" class="b" style="font-size: 80%;">Отпускные +</a></div>';
                        ...
                        echo '
                                                ...
                                                <a href="fl_akt_print.php?tabel_id=' . $tabel_j[0]['id'] . '&noch=0"  target="_blank" rel="nofollow noopener" class="b" style="font-size: 80%;" >Акт</a>';
