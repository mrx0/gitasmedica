...
//                    </script>';
            ...
            echo '
                    <div id="status">
                        <header>
                            ...
                            <h1>Прочие доплаты сотрудникам (фиксированные)</h1>
                        </header>';
            ...
            echo '		
                            ...
                            <li class="cellsBlock" style="font-weight: bold; width: auto; text-align: right; margin-bottom: 10px;">
                                ...
                                <a href="fl_surcharges.php?who=5" class="b" style="'.$stom_color.'">Стоматологи</a>
                                <a href="fl_surcharges.php?who=6" class="b" style="'.$cosm_color.'">Косметологи</a>
                                <a href="fl_surcharges.php?who=10" class="b" style="'.$somat_color.'">Специалисты</a>
                                <a href="fl_surcharges.php?who=4" class="b" style="'.$admin_color.'">Администраторы</a>
                                <a href="fl_surcharges.php?who=7" class="b" style="'.$assist_color.'">Ассистенты</a>
                                <a href="fl_surcharges.php?who=13" class="b" style="'.$sanit_color.'">Санитарки</a>
                                <a href="fl_surcharges.php?&who=14" class="b" style="'.$ubor_color.'">Уборщицы</a>
                                <a href="fl_surcharges.php?who=15" class="b" style="'.$dvornik_color.'">Дворники</a>
                                <a href="fl_surcharges.php?who=11" class="b" style="'.$other_color.'">Прочие</a>';
            if (in_array($_SESSION['permissions'], $workers_target_arr) || ($_SESSION['id'] == 270) || $god_mode) {
                echo '
                                <a href="fl_surcharges2.php" class="b" style="">Другие</a>';
            }
            echo '
                            </li>';
...
//                    }
                    ...
                    $query = "SELECT * FROM `fl_spr_surcharges` WHERE `worker_id` = '{$worker['id']}' AND `type` = '1' LIMIT 1";
                    ...
                    echo '
                                    <!--<div class="cellName" style="text-align: center; padding: 4px 0 0;">
                                        <a href="fl_edit_salary.php?worker_id='.$worker['id'].'" class="ahref">'.$Sur.'</a>
                                    </div>-->
                                    <!--<div class="cellName" style="text-align: center; padding: 4px 0 0;">
                                        С какого числа
                                    </div>-->
                                    ...
                                    <div class="cellName" style="text-align: center; padding: 4px 0 0;">
                                        <div class="changeCurrentSur" worker_id="'.$worker['id'].'" style="display: inline; cursor: pointer;" >'.number_format($Sur, 2, '.', '').'</div> <div id="textAfterSur" style="display: inline;">руб. </div>
