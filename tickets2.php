                ...
                foreach ($tickets_arr as $j_tickets) {
                    ...
                    if (!$ticket_deleted) {
                        ...
                        echo '
                            ...
                            <td  style="padding: 5px 10px; border: 1px solid #CCC; border-left: none; border-right: none;">
                                <a href="ticket.php?id='.$j_tickets['id'].'&'.$show_option_str_for_paginator.'" class="ticketBlockmain_table ahref">
                                    '.$descr.'<br>
