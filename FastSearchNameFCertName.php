...
//                    }
                    ...
                    //if (($fast_search[$i]['cell_time'] != '0000-00-00 00:00:00') && ($fast_search[$i]['status'] == 7)) {
                        ...
                        if (($fast_search[$i]['cell_time'] == '0000-00-00 00:00:00') && ($fast_search[$i]['status'] != 7)) {
                            $rez .= '
                                        <span style="background-color: rgba(20 255 45 / 70%)">нет</span>';
                        } else {
                        ...
                        if (!$expired && !$debited) {
                            if ($fast_search[$i]['client_id'] != 0) {
                                ...
                                $rez .= "<td style = 'text-align: center; cursor: pointer;' onclick = 'changeCertificateNameId(" . $fast_search[$i]['id'] . ")' ><i class='fa fa-check' aria - hidden = 'true' ></i ></td >";
                            }
                        }else{
                            $rez .= "<td style = 'text-align: center;'></td >";
                        }
