...
//Добавить выдачу
    ...
    //            var_dump($year);
                ...
                echo '
                    <div id="status">
                        <header>
                            ...
                            <h2>Добавить Выдано АН</h2>
                            <a href="fl_to_director_all.php?filial='.$filial_id.'" class="b">Смотреть все</a>
                        </header>';
                ...
                echo '
                                <div id="errror"></div>
                                <input type="button" class="b" value="Добавить" onclick="fl_showAjaxAddToDirector(\'add\')">
                            </form>';
