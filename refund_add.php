				...
				if (isset($_GET['invoice_id'])){
					...
					if ($invoice_j != 0){
                        ...
                        echo '			
                                    ...
                                    <span style="color: red; font-size: 80%;">Возврат средств на счёт возможен только если за наряд была выплачена ЗП. Во всех остальных случаях удалите оплату с наряда.</span>
                                     <div id="errror"></div>';
