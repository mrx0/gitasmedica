	...
	if ($enter_ok){
		...
		echo '
			...
			echo '
				...
				<div id="data">';
					echo '<span style="font-size: 90%; color: red;">После любого обновления прогораммы, необходимо обновить браузер.<br>Сделать это можно, нажав на клавиатуре кнопку <b>F5</b>.</span><br><br>';
					...
					echo '
						...
						А также нажав на иконку <i class="fa fa-info-circle" title="Профиль"></i> возле фамилии в Плановом или фактическом графиках.<br>
