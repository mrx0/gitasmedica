...
//DB::query() выполнить один запрос к БД с возвращением результата PDOStatement. его следует использовать только в том случае,
// если запрос не содержит необработанные данные, например из внешних источников.
