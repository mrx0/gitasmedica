...
//add_guarantee_in_invoice_f.php
//Добавление гарантии в сессионную переменную наряда (!!!зачем, если есть общее для гарантии и подарка)
	...
	if (empty($_SESSION['login']) || empty($_SESSION['id'])){
		...
		if ($_POST){
			...
			if (!isset($_POST['guarantee']) || !isset($_POST['invoice_type']) || !isset($_POST['client']) || !isset($_POST['zapis_id']) || !isset($_POST['filial']) || !isset($_POST['worker'])){
