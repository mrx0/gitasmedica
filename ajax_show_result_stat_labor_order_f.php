...
//ajax_show_result_stat_labor_order_f.php
...
if (empty($_SESSION['login']) || empty($_SESSION['id'])){
    ...
    //var_dump ($_POST);
    if ($_POST){
        if (isset($_POST['all_time']) && isset($_POST['dataend']) && isset($_POST['datastart']) && isset($_POST['filial']) && isset($_POST['labor']) && isset($_POST['worker']) && isset($_POST['client']) && isset($_POST['status'])) {
...
//            }
            ...
            if ($creatorExist && $workerExist) {
                if ($clientExist) {
                    ...
                    echo json_encode(array('result' => 'error', 'data' => '<div class="query_neok">Не найден пациент.</div>'));
                }
            } else {
                echo json_encode(array('result' => 'error', 'data' => '<div class="query_neok">Не найден сотрудник.</div>'));
            }
        }else{
