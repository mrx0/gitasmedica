...
//							</li>';
            ...
            //Пагинатор
            echo paginationCreate ($limit_pos[1], $_GET['page'], 'notes', 'temp_notes_cert.php', $msql_cnnct, $dop, $dop_link_str);
...
//						</li>';
			...
			//var_dump ($cert_j);
            $query = "SELECT * FROM `notes` {$dop} ORDER BY `create_time` ASC LIMIT {$limit_pos[0]}, {$limit_pos[1]}";
