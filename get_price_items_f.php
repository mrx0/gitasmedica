...
//get_price_items_f.php
//получаем элементы прайса
                ...
                if ($number != 0) {
                    ...
                    $rezult .= 	'
                            <tr class="sclad_item_tr" style="font-size: 80%; font-weight: bold;">
                                ...
                                <td style="width: 60px; max-width: 60px; min-width: 60px; border-top: 1px solid #CCC; text-align: center;">Код</td>
								...
								<td style="width: 60px; border-top: 1px solid #CCC; text-align: center;">Цена</td>
                        ...
                        $rezult .= 	'
                            <tr id="itemSclad_'.$arr['id'].'" class="draggable sclad_item_tr">
                                <td style="border-left: 1px solid #CCC; text-align: center;">
                                    <a href="pricelistitem.php?id='.$arr['id'].'" class="ahref"  target="_blank" rel="nofollow noopener"><i class="fa fa-folder-open-o" aria-hidden="true" style="color: #000000; text-shadow: 1px 1px 1px #ffc90f;"></i></a> 
                                </td>
                                <td style="text-align: left; font-size: 80%;">'.$arr['code_mkb'].'</td>
