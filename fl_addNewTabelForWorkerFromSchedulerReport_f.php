    ...
    if (empty($_SESSION['login']) || empty($_SESSION['id'])){
        ...
        if ($_POST) {
            ...
            if (!isset($_POST['worker_id']) || !isset($_POST['filial_id']) || !isset($_POST['type']) ||
                ...
                !isset($_POST['per_from_salary']) || !isset($_POST['filialmoney']) || !isset($_POST['worker_category_id']) ||
                ...
                if (($_POST['filial_id'] != 0) && ($_POST['w_hours'] != 0)) {
                    ...
                    `per_from_salary`, `filial_summ`, `category`,
                    ...
                    '{$_POST['per_from_salary']}', '{$_POST['filialmoney']}','{$_POST['worker_category_id']}', 
