...
//Заголовок страниц сайта
	...
	if ($enter_ok){
        ...
        echo '<li title="Обновить"><a onclick="document.location.reload(true);" style="color: rgb(175, 115, 230); font-size: 110%; /*text-shadow: 1px 1px rgba(52, 152, 219, 0.8);*/"><i class="fa fa-retweet" aria-hidden="true"></i></a></li>';
	}
