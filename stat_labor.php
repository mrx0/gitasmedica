...
//stat_labor.php
//Статистика по лабораторным заказам
			...
			if ($_POST){
                ...
                if (!empty($filials_j)) {
                    foreach ($filials_j as $f_id => $filials_j_data) {
                        echo '    
                                                    <li><option value="'.$f_id.'" class="icon-twitter icon-large">'.$filials_j_data['name'].'</option></li>';
				    }
			    }
			    echo '
                                                </ul>
                ...
                echo '
                                            <select id="filial" class="wrapper-dropdown-2 b2" tabindex="2" name="labor">
                                                <ul class="dropdown">
                                                    <li><option value="99" selected>Все</option></li>';
                ...
                if ($lab_j != 0){
                    for ($i=0;$i<count($lab_j);$i++){
                        echo '
                                                    <li><option value="'.$lab_j[$i]['id'].'" class="icon-twitter icon-large">'.$lab_j[$i]['name'].'</option></li>';
                    }
                }
                echo '
									            </ul>
                ...
                echo '				
								...
								<li class="filterBlock">
									...
									<div class="filtercellRight" style="width: 245px; min-width: 245px;">
										...
										<input type="checkbox" id="zapisCreate" name="zapisCreate" class="zapisType" value="1" checked> Создан<br>
										<input type="checkbox" id="zapisInLab" name="zapisInLab" class="zapisType" value="1"> Отправлен в лабораторию<br>
										<input type="checkbox" id="zapisArrive" name="zapisArrive" class="zapisType" value="1"> Пришел из лаборатории<br>
										<input type="checkbox" id="zapisClosed" name="zapisClosed" class="zapisType" value="1"> Закрытые<br>
									</div>
								</li>';
				...
				echo '
                        <div class="no_print"> 
						<input type="button" class="b" value="Применить" onclick="Ajax_show_result_stat_labor()">
						</div>';
