...
//                }
                ...
                if ($tabel_j != 0){
                    ...
                    //Получим выплаты отдельно, !!! потом надо будет переделать, а то лишний запрос какой-то
                    ...
                    if (($_GET['type'] == 1) || ($_GET['type'] == 7) || ($_GET['type'] == 4)){
                        ...
                        if (($tabel_j[0]['k_plus'] != 0) || ($tabel_j[0]['k_minus'] != 0)){
                            $paidout_summ_value = $paidout_summ_value + $paidout_summ_value/100*($tabel_j[0]['k_plus'] - $tabel_j[0]['k_minus']);
                        }
                        //var_dump($summItog);

                        $paidout_summ_value = $paidout_summ_value - $tabel_j[0]['deduction'] - $paidoutssSumm;
                    }
