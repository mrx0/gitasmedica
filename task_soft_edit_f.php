	...
	if (empty($_SESSION['login']) || empty($_SESSION['id'])){
		...
		if ($_POST){
			if ($_POST['description'] == ''){
				...
				<a href="task_soft_edit.php?id='.$_POST['id'].'" class="b">Добавить</a>
				<a href="soft.php" class="b">В журнал</a>';
			}else{
				include_once 'DBWork.php';
				WriteToJournal_Update ($_POST['id'], $_POST['filial'], $_POST['description'], $_SESSION['id'], $_POST['priority'], 'journal_soft');
