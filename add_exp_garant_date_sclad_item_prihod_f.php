...
//add_exp_garant_date_sclad_item_prihod_f.php
//
	...
	if (empty($_SESSION['login']) || empty($_SESSION['id'])){
		...
		if ($_POST){
			...
			if (!isset($_POST['eg_date']) || !isset($_POST['item_id']) || !isset($_POST['ind']) || !isset($_POST['prihod_id']) || !isset($_POST['edit'])){
                ...
                if ($_POST['edit'] == 'true') {
                    ...
                    if (isset($_SESSION['sclad']['items_prihod_data_edit'])) {
                        if (isset($_SESSION['sclad']['items_prihod_data_edit'][$_POST['prihod_id']])) {
                            if (isset($_SESSION['sclad']['items_prihod_data_edit'][$_POST['prihod_id']][$_POST['item_id']][$_POST['ind']])) {
                                $_SESSION['sclad']['items_prihod_data_edit'][$_POST['prihod_id']][$_POST['item_id']][$_POST['ind']]['exp_garant_date'] = $_POST['eg_date'];
                            }
                        }
                    }
                }else{
                    ...
                    if (isset($_SESSION['sclad']['items_prihod_data'])) {
                        if (isset($_SESSION['sclad']['items_prihod_data'][$_POST['item_id']][$_POST['ind']])) {
                            $_SESSION['sclad']['items_prihod_data'][$_POST['item_id']][$_POST['ind']]['exp_garant_date'] = $_POST['eg_date'];
