    ...
    if (empty($_SESSION['login']) || empty($_SESSION['id'])){
        ...
        if ($_POST){
            ...
            if (!isset($_POST['tabel_id']) || !isset($_POST['deduction_summ'])){
                ...
                $query = "INSERT INTO `fl_journal_deductions` (`tabel_id`, `summ`, `descr`, `create_time`, `create_person`)
                            VALUES (
                            '{$_POST['tabel_id']}', '".round($_POST['deduction_summ'], 2)."', '{$_POST['descr']}', '{$time}', '{$_SESSION['id']}');";
