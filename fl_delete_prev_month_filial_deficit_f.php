...
//fl_delete_prev_month_filial_deficit_f.php
//Функция удаления дефицита
...
//                $deficit_id = 0;
                ...
                if (($date >= $todaydate) || ($_SESSION['permissions'] == 3)) {
                    ...
                    $query = "DELETE FROM `fl_journal_prev_month_filial_deficit` WHERE `filial_id` = '{$_POST['filial_id']}' AND `year` = '{$_POST['year']}' AND `month` = '{$_POST['month']}'";
                    ...
                    echo json_encode(array('result' => 'error', 'data' => 'Ошибка #62. Нельзя сохранять/обновлять данные прошлыми датами.'));
                }
