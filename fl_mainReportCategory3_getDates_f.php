...
//Отдельная функция, которая вернёт данные по категориям для отчета и отрисует табличку
    ...
    if (empty($_SESSION['login']) || empty($_SESSION['id'])){
        ...
        if ($_POST) {
            if (!isset($_POST['cats']) || !isset($_POST['month_start']) || !isset($_POST['year_start']) || !isset($_POST['month_end']) || !isset($_POST['year_end']) || !isset($_POST['filial_id'])) {
                ...
                echo json_encode(array('result' => 'success', 'data' => $_POST['cats']));
