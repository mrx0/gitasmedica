...
//add_price_id_stom_in_invoice_f.php
//
                ...
                if (isset($_SESSION['invoice_data'])) {
                    ...
                    if ($_SESSION['invoice_data'][$_POST['client']][$_POST['zapis_id']]['t_number_active'] != 0) {
                        ...
                        if (isset($_SESSION['invoice_data'][$_POST['client']][$_POST['zapis_id']]['data'][$t_number_active])) {
                            ...
                            //выбрать категорию, указанную в прайсе
                            $query = "SELECT `category` FROM `spr_pricelist_template` WHERE `id`='".(int)$_POST['price_id']."';";
                            ...
                            if ($number != 0) {
                                ...
                                $temp_arr['percent_cats'] = (int)$arr['category'];
                            }

                            if ($temp_arr['percent_cats'] == 0){
