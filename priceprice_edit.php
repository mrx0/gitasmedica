                    ...
                    if ($rez != 0){
                        for($i=0; $i < count($rez); $i++){
                            ...
                            if ((($items['close'] == 1) && ($finances['close'] == 1)) || $god_mode){
                                echo '
						        <i class="fa fa-times" aria-hidden="true" style="cursor: pointer; color: red;"  title="Удалить" onclick="deleteThisPrice(' . $rez[$i]['id'] . ', false);"></i>';
                            }
                            echo '
