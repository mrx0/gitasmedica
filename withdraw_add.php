...
//                    }
                    ...
                    echo '
                                <li style="font-size: 85%; color: #7D7D7D; margin-bottom: 5px;">
                                    <span style="color: #7D7D7D; margin-bottom: 5px;">
					...
					echo '
								<li style="font-size: 85%; color: #7D7D7D; margin-bottom: 5px;">
									<span style="color: rgb(125, 125, 125);">
									    Дата выдачи: <input type="text" id="date_in" name="date_in" class="dateс" style="border:none; color: rgb(30, 30, 30); font-weight: bold;" value="'.date("d").'.'.date("m").'.'.date("Y").'" onfocus="this.select();_Calendar.lcs(this)" 
                        ...
                        echo '
							<div class="cellsBlock2">
								<div class="cellRight">
								    <ul style="margin-left: 6px; margin-bottom: 10px;">
								        <li style="font-size: 85%; color: #7D7D7D; margin-bottom: 5px;">
								            Способ выдачи  <label id="summ_type_error" class="error"></label>
                                        </li>
                                        <li style="font-size: 90%; margin-bottom: 5px;">
                                            ...
                                            <input type="checkbox" name="org_pay" value="1" style="display: none;"><!-- от Организации-->
									    </li>
								    </ul>
								</div>
							</div>';
                    ...
                    echo '
                            <div>
                                ...
                                <input type="button" class="b" value="Сохранить" onclick="showWithdrawAdd(\'add\')">
                            </div>
                        </div>
