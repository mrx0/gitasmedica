...
//
//                        echo '
//                                    <input type="hidden" id="ticket_id" value="'.$tasks_j[0]['id'].'">
//                                </header>';
//
//                        echo '
//                                <div id="data" style="">
...
//                            if ($ticket_done_btn) {
//                                if ($ticket_done) {
//                                    echo '<button class="b4" value="Вернуть в работу" onclick="Ajax_ticket_restore(' . $tasks_j[0]['id'] . ')"> Вернуть в работу <i class="fa fa-briefcase" aria-hidden="true" style="color: green; text-shadow: 1px 1px rgba(52, 152, 219, 0.8);"></i></button>';
//                                } else {
...
//                                                </div>
//                                                <div>
//                                                    <input type="submit" id="msg_send" class="msg_send" value="Отправить" onclick="Add_newComment_inTicket(' . $tasks_j[0]['id'] . ');">
//                                                </div>';
//                        }
//                        echo '
//                                            </div>
