$(function(){
    ...
    $('#upload').fileupload({
        ...
        add: function (e, data) {
           ...
           tpl.find('input').knob();
            //tpl.find('input').text('<img src="uploads/'+data.files[0].name+'">');
		//	$('canvas').replaceWith('<img src="uploads/'+data.files[0].name+'">');
//tpl.find('canvas').text('<img src="uploads/'+data.files[0].name+'">');
