...
//fl_surcharges2.php
//Доплаты прочее (отдельно для Другие)
...
//                    </script>';
            ...
            echo '		
                            ...
                            <li class="cellsBlock" style="font-weight: bold; width: auto; text-align: right; margin-bottom: 10px;">
                                ...
                                <a href="fl_surcharges.php?who=5" class="b" style="">Стоматологи</a>
                                <a href="fl_surcharges.php?who=6" class="b" style="">Косметологи</a>
                                <a href="fl_surcharges.php?who=10" class="b" style="">Специалисты</a>
                                <a href="fl_surcharges.php?who=4" class="b" style="">Администраторы</a>
                                <a href="fl_surcharges.php?who=7" class="b" style="">Ассистенты</a>
                                <a href="fl_surcharges.php?who=13" class="b" style="">Санитарки</a>
                                <a href="fl_surcharges.php?&who=14" class="b" style="">Уборщицы</a>
                                <a href="fl_surcharges.php?who=15" class="b" style="">Дворники</a>
                                <a href="fl_surcharges.php?who=11" class="b" style="">Прочие</a>';
            if (in_array($_SESSION['permissions'], $workers_target_arr) || ($_SESSION['id'] == 270) || $god_mode) {
                echo '
                                <a href="fl_surcharges2.php" class="b" style="background-color: #fff261;">Другие</a>';
            }
            echo '
                            </li>';
