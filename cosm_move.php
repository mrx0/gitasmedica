...
//cosm_move.php
//Перенос посещений пациента к другому
			...
			if ($client !=0){
				...
				echo '
						<span style="font-size: 85%; color: #FF0202; margin-bottom: 5px;">
							<i class="fa fa-exclamation-triangle" aria-hidden="true" style="font-size: 120%;"></i> Данное действие невозможно будет отменить. Перенесутся все данные.
						</span><br>';
