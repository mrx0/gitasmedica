                ...
                if (isset($_SESSION['fl_calcs_tabels2'])) {
                    ...
                    if (!empty($_SESSION['fl_calcs_tabels2'])) {
                        ...
                        foreach ($calcArr as $calcID => $status) {
                            ...
                            if (!$tabel_noch) {
                                $query = "SELECT `id` FROM `fl_journal_tabels_ex` WHERE `calculate_id` = '$calcID' AND `noch`='0';";
                            }else{
                                $query = "SELECT `id` FROM `fl_journal_tabels_ex` WHERE `calculate_id` = '$calcID' AND `noch`='1';";
                            }
