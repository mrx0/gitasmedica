...
//Функция для редактирования карточки пациента
	...
	if (empty($_SESSION['login']) || empty($_SESSION['id'])){
		...
		if ($_POST){
			...
			WriteClientToDB_Update ($_POST['session_id'], $_POST['id'], $_POST['comment'], $_POST['card'], $therapist, $therapist2, $birthday, $_POST['sex'], $_POST['telephone'], $_POST['passport'], $_POST['passportvidandata'], $_POST['passportvidankem'], $_POST['address'], $_POST['polis']);
