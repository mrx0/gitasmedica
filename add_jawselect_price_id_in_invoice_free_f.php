...
//add_jawselect_price_id_in_invoice_free_f.php
//
	...
	if (empty($_SESSION['login']) || empty($_SESSION['id'])){
		...
		if ($_POST){
			...
			if (!isset($_POST['jaw_select']) || !isset($_POST['invoice_type']) || !isset($_POST['filial'])){
					...
					foreach ($data as $zub => $invoice_data){
						...
						if (!empty($invoice_data)){
							if ($_POST['invoice_type'] == 88){
                                ...
                                $data = $_SESSION['invoice_data']['free_invoice']['data'][$zub]['jaw_select'] = (int)$_POST['jaw_select'];
