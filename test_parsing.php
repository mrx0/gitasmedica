...
//тест парсинга
	...
	if ($enter_ok){
		...
		if (($it['add_own'] == 1) || ($it['add_new'] == 1) || $god_mode){
            ...
            echo '
            <form action="test_parsing_excel_upload_upload.php" method="post" enctype="multipart/form-data">
                <input type="file" name="excel_file" accept=".xls,.xlsx" required>
                <button type="submit">Загрузить и обработать</button>
              </form>';

			// echo '
			// 			<form action="test_parsing_handle_pdf_upload.php" method="post" enctype="multipart/form-data">';
            //
            // echo '
